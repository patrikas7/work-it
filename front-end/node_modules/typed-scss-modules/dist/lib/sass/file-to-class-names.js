...
const transformersMap = {
    camel: (className) => (0, change_case_1.camelCase)(className),
...
exports.NAME_FORMATS = Object.keys(transformersMap).concat(["all"]);
exports.nameFormatDefault = "camel";
const fileToClassNames = (file, { additionalData, includePaths = [], nameFormat, implementation, aliases, aliasPrefixes, importer, } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const { renderSync } = (0, implementations_1.getImplementation)(implementation);
    let nameFormats = nameFormat
        ? (nameFormat.includes("all")
            ? exports.NAME_FORMATS.filter((item) => item !== "all")
            : nameFormat)
